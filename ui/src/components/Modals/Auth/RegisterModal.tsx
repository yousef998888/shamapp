...
export function RegisterModal({
  ...
  const { signUpWithEmail, signUpWithGoogle, signUpLoading, signUpError } =
    useAuth();
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      {/* <DialogTrigger asChild>
        <Button variant="default">{t('auth.signup.createAccount')}</Button>
      </DialogTrigger> */}
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
            <div className="space-y-4 lg:border-e-2 lg:pe-4 max-lg:border-b-2 max-lg:pb-6 ">
              ...
              <Button type="submit" className="w-full py-5 rounded-full" disabled={signUpLoading}>
                {signUpLoading ? t('auth.signup.signingUp') : t('auth.signup.createAccount')}
              </Button>
              {signUpError && (
            ...
            <div className="flex flex-col space-y-3">
              ...
              <Button variant="outline" className="py-5 border-2 rounded-full" type="button" disabled>
                ...
                {t('auth.signup.signUpWithFacebook')}
              </Button>
